...
<head>
    ...
    <title>Pacientes - Óptica Latitud Visual</title>
...
<body>
    ...
    <nav class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="${pageContext.request.contextPath}/fichas" class="nav-link">
        ...
        tbody.innerHTML = pacientes.map(p => `
            <tr>
                <td>
                    ...
                    <small class="text-muted">\${calcularEdad(p.fechaNacimiento)} Años</small>
                </td>
                <td>
                    <div>\${p.cedula}</div>
                </td>
