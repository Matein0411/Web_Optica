...
public abstract class BaseDAO<T> {
     ...
     */
    public List<T> obtenerLista(int maxResults, int firstResult) {
        return obtenerLista(false, maxResults, firstResult);
    }
     ...
     */
    private List<T> obtenerLista(boolean all, int maxResults, int firstResult) {
