            ...
            <div class="modal-content">
                ...
                <i class="fas fa-eye me-2"></i>Lentes de Contacto
                            ...
                            <div class="tab-pane fade show active" id="preliminares" role="tabpanel">
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-8">
                                        ...
                                        <textarea class="form-control" id="mpc" name="mpc" rows="2" placeholder="Ej. Dificultad para ver de cerca, dolor de cabeza..." required></textarea>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkCristal" name="materialCristal"><label class="form-check-label small" for="chkCristal">Cristal</label></div>
                                                </div>
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkCR39" name="materialCr39"><label class="form-check-label small" for="chkCR39">CR-39</label></div>
                                                </div>
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkPoly" name="materialPolicarbonato"><label class="form-check-label small" for="chkPoly">Policarbonato</label></div>
                                                </div>
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkProgresivo" name="materialProgresivo"><label class="form-check-label small" for="chkProgresivo">Progresivo</label></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkFiltroAzul" name="filtroAzul"><label class="form-check-label small" for="chkFiltroAzul">Filtro Azul</label></div>
                                                </div>
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkTransition" name="filtroTransition"><label class="form-check-label small" for="chkTransition">Transition</label></div>
                                                </div>
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkAntiReflejante" name="filtroAntiReflejante"><label class="form-check-label small" for="chkAntiReflejante">Anti-Reflejante</label></div>
                                                </div>
                                                <div class="col-md-3 col-6">
                                                    <div class="form-check"><input class="form-check-input" type="checkbox" id="chkFotocromatico" name="filtroFotocromatico"><label class="form-check-label small" for="chkFotocromatico">Fotocromático</label></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="form-control" id="observaciones" name="observaciones" rows="2" placeholder="Ej. Se recomienda uso permanente. Revisión en 6 meses."></textarea>
                        </div>
                    </form>
                </div>
