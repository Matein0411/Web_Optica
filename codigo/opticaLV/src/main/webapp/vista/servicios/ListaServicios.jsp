...
<head>
  ...
  <title>Servicios - Óptica Latitud Visual</title>
...
<jsp:include page="../comun/siderbar.jsp">
  <jsp:param name="activeMenu" value="servicios" />
</jsp:include>
          ...
          <tr>
            ...
            <td>
                            <span class="text-muted">
                                ${servicio.descripcion != null && !servicio.descripcion.isEmpty() ? servicio.descripcion : '-'}
                            </span>
            </td>
            <td>
                            <span class="badge-price">
                                <fmt:formatNumber value="${servicio.precioBase}" type="currency" currencySymbol="$" minFractionDigits="2" maxFractionDigits="2"/>
                            </span>
            </td>
            <td class="text-end">
              <button class="btn btn-light text-primary shadow-sm"
                      title="Editar" onclick="editarServicio(${servicio.id})">
                <i class="fas fa-edit"></i>
              </button>
              <button class="btn btn-light text-danger shadow-sm"
                      title="Desactivar" onclick="confirmarDesactivar(${servicio.id}, '${servicio.nombre}')">
...
<!-- Modal Servicio -->
<jsp:include page="FormularioServicio.jsp" />
