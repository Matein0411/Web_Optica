            ...
            <div class="modal-body">
                <form id="formFicha">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-8">
                            <label for="comboPaciente" class="form-label required-field">Paciente</label>
                            <select class="form-select" id="comboPaciente" style="width: 100%;">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="preliminares" role="tabpanel">
                            <div class="section-title"><i class="fas fa-clipboard-list me-2"></i>Anamnesis</div>
                            <div class="row g-3 mb-4">
                                <div class="col-md-8">
                            ...
                            <div class="section-title"><i class="fas fa-history me-2"></i>RX Anterior (Uso Actual)</div>
                            <div class="table-responsive mb-4">
                                <table class="table table-bordered table-sm text-center align-middle">
                                    <thead class="table-light">
                                    <tr>
                                        <th>Ojo</th><th>Esfera</th><th>Cilindro</th><th>Eje</th><th>ADD</th><th>AV SC</th><th>AV CC</th><th>Prismas</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="section-title"><i class="fas fa-eye-dropper me-2"></i>Examen Externo</div>
                                ...
                                <div class="col-md-6">
                                    <div class="card bg-light border">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2"><label class="small text-muted">Oftalmoscopía</label><input type="text" class="form-control form-control-sm" id="oftalmoscopiaOd" name="oftalmoscopiaOd"></div>
                                            <div class="mb-2"><label class="small text-muted">Retinoscopía</label><input type="text" class="form-control form-control-sm" id="retinoscopiaOd" name="retinoscopiaOd"></div>
                                            <div class="mb-0"><label class="small text-muted">Queratometría</label><input type="text" class="form-control form-control-sm" id="queratometriaOd" name="queratometriaOd"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card bg-light border">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2"><label class="small text-muted">Oftalmoscopía</label><input type="text" class="form-control form-control-sm" id="oftalmoscopiaOi" name="oftalmoscopiaOi"></div>
                                            <div class="mb-2"><label class="small text-muted">Retinoscopía</label><input type="text" class="form-control form-control-sm" id="retinoscopiaOi" name="retinoscopiaOi"></div>
                                            <div class="mb-0"><label class="small text-muted">Queratometría</label><input type="text" class="form-control form-control-sm" id="queratometriaOi" name="queratometriaOi"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="lunas" role="tabpanel">
                            <div class="section-title"><i class="fas fa-glasses me-2"></i>Refracción Final (Gafas)</div>
                            <div class="table-responsive mb-4">
                                <table class="table table-bordered text-center align-middle">
                                    <thead class="table-light">
                                    <tr>
                                        <th style="width: 50px;">RX</th><th>Esfera</th><th>Cilindro</th><th>Eje</th><th>ADD</th><th>AV</th><th>DNP</th><th>Prisma</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                            ...
                            <div class="card bg-light border-0 p-3">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkCristal" name="materialCristal"><label class="form-check-label small" for="chkCristal">Cristal</label></div></div>
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkCR39" name="materialCr39"><label class="form-check-label small" for="chkCR39">CR-39</label></div></div>
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkPoly" name="materialPolicarbonato"><label class="form-check-label small" for="chkPoly">Policarbonato</label></div></div>
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkProgresivo" name="materialProgresivo"><label class="form-check-label small" for="chkProgresivo">Progresivo</label></div></div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label fw-bold small text-muted">Filtros y Tratamientos</label>
                                        <div class="row g-2">
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkFiltroAzul" name="filtroAzul"><label class="form-check-label small" for="chkFiltroAzul">Filtro Azul</label></div></div>
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkTransition" name="filtroTransition"><label class="form-check-label small" for="chkTransition">Transition</label></div></div>
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkAntiReflejante" name="filtroAntiReflejante"><label class="form-check-label small" for="chkAntiReflejante">Anti-Reflejante</label></div></div>
                                            <div class="col-md-3 col-6"><div class="form-check"><input class="form-check-input" type="checkbox" id="chkFotocromatico" name="filtroFotocromatico"><label class="form-check-label small" for="chkFotocromatico">Fotocromático</label></div></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="contactos" role="tabpanel">
                            <div class="section-title"><i class="fas fa-eye me-2"></i>Lentes de Contacto (Opcional)</div>
                            <div class="table-responsive mb-4">
                                <table class="table table-bordered text-center align-middle">
                                    <thead class="table-light">
                                    <tr>
                                        <th style="width: 50px;">RX</th><th>Esfera</th><th>Cilindro</th><th>Eje</th><th>ADD</th><th>AV</th><th>Tipo LC</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control text-center" id="lcOdTipo" name="lcOdTipo" placeholder="Ej. Tórico"></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold bg-light">OI</td>
                                        ...
                                        <td><input type="text" class="form-control text-center" id="lcOiTipo" name="lcOiTipo" placeholder="Ej. Tórico"></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
...
<script>
// Cuando el modal se muestra, inicializamos Select2
document.addEventListener('DOMContentLoaded', function() {
    // Escuchar el evento de apertura del modal (desde Bootstrap)
...
// Función para convertir el select normal en un buscador
function inicializarSelect2() {
    const $select = $('#comboPaciente');
    
    // Si ya está inicializado, no hacer nada para evitar doble carga
    ...
    $select.select2({
        theme: 'bootstrap-5',
        dropdownParent: $('#modalFicha'), // Vital para que funcione en modal
        placeholder: 'Escriba nombre o cédula...',
        allowClear: true,
        // Configuración para cargar datos remotamente (AJAX)
        ajax: {
            url: '${pageContext.request.contextPath}/pacientes',
            dataType: 'json',
            delay: 250, // Esperar un poco al escribir
            data: function (params) {
                return {
                    accion: 'buscar',
                    criterio: params.term || '' // Término de búsqueda
                };
            },
            processResults: function (data) {
                // Transformar datos del servidor al formato de Select2
                return {
                    results: data.map(function (p) {
                        return {
                            id: p.id,
                            text: p.nombre + ' ' + p.apellido ,
                            cedula: p.cedula // Dato extra
                        };
                    })
                };
            },
    ...
    $select.on('select2:select', function (e) {
        ...
        document.getElementById('pacienteCedula').innerText = 'Cédula: ' + (data.cedula || '---');
    });
